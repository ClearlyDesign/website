...
| Factor | Freelance Designer | Fractional Design Partner |
|---|---|---|
| **Typical cost** | $50-$250/hr or $1K-$20K/project | $3K-$10K/mo retainer |
| **Engagement type** | Project-based, ends at delivery | Ongoing monthly retainer |
| **Context depth** | Starts fresh each project | Builds over time (compounds) |
| **Strategic input** | Executes briefs as given | Challenges and improves briefs |
| **Brand consistency** | Varies (different people, different projects) | High (one person across all touchpoints) |
| **Availability** | Unpredictable (books up) | Reserved and guaranteed |
| **Best for** | One-time, well-defined projects | Ongoing SaaS design across marketing and product |
...
Considering an agency or full-time hire instead? Read our [design agency vs in-house designer comparison](/resources/design-agency-vs-in-house-designer-saas). For help choosing a pricing model, see [fixed-price vs retainer for SaaS design](/resources/fixed-price-vs-retainer-design-saas).
