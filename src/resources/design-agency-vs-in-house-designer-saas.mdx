...
| Factor | In-House Designer | Design Agency | Fractional Partner |
|---|---|---|---|
| **Typical cost** | $150K-$170K/yr all-in | $5K-$15K/mo retainer or $15K-$60K/project | $3K-$10K/mo |
| **Time to start** | 3-6 months (hiring + onboarding) | 2-4 weeks | 1 week |
| **Seniority level** | Depends on budget | Senior pitch, junior execution | Senior throughout |
| **Strategic input** | Depends on hire | Varies by agency | Built in |
| **Brand context** | Deep (over time) | Shallow (resets per project) | Deep (over time) |
| **Commitment** | Full-time salary + benefits | Project or retainer contract | Monthly retainer |
| **Best for** | Post-Series B with daily design needs | Major strategic projects (rebrand, launch) | Pre-Series B ongoing design needs |
...
If you're also evaluating freelancers, see our guide on [freelance designers vs fractional design partners](/resources/freelance-designer-vs-fractional-design-partner). For help deciding how to structure the engagement, read [fixed-price vs retainer for SaaS design](/resources/fixed-price-vs-retainer-design-saas).
