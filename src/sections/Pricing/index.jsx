              ...
              {plans.map((plan) => (
                <div key={plan.title}>
                  <div className="bg-gradient-to-t from-gray-950 to-indigo-950 p-7 rounded-t-2xl">
                    <p className="text-4xl font-bold tracking-tighter text-lime-400">
                      {plan.title}
                    </p>
...
const plans = [
  {
    ...
    price: "$2,495",
    spots: "Introductory offer. 4 spots left",
    link: "https://buy.stripe.com/5kAbLu4yf3IJf3G8wx?prefilled_promo_code=C1",
    includes: [
      {
