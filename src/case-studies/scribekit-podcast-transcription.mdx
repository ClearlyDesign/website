...
<h2 className="flex items-center gap-3 m-0"><span className="icon-container rose"><XCircleIcon/></span> The Problem</h2>
...
<h2 className="flex items-center gap-3 m-0"><span className="icon-container yellow"><LightBulbIcon/></span> The Solution: ScribeKit</h2>
...
<h2 className="flex items-center gap-3 m-0"><span className="icon-container blue"><ArrowTrendingUpIcon/></span> The Results</h2>
...
<h2 className="flex items-center gap-3 m-0"><span className="icon-container purple"><BookOpenIcon/></span> What Made This Work</h2>
...
<h2 className="flex items-center gap-3 m-0"><span className="icon-container emerald"><CursorArrowRippleIcon/></span> The Business Impact</h2>
...
<h2 className="flex items-center gap-3 m-0"><span className="icon-container blue"><BoltIcon/></span> Lessons for Other Teams</h2>
